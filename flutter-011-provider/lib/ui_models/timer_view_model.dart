...
class TimerViewModel extends ChangeNotifier {
  ...
  /// 이미 생성된 객체를 재활용(다시 이용)하는 기법이 있다.
  /// static(프로젝트가 start 되면 자동으로 객체 생성)에 비해서 필요한 경우만
  /// 객체를 한번 생성하여 재활용 한다는 의미에서
  ...
  Future<int> getTimer() async {
    // 이 클래스에서 만들어진 _prefs 객체를 private 로 사용하기 위하여 요구하기
