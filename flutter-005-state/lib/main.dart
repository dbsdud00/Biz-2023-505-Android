...
/// State Widget 에서는 StatefulWidget 과 관계를 명확히 하기 위하여
/// Generic(<HomePate>)을 연결하여 준다.
class StartPage extends State<HomePage> {
  ...
  final studentList = [
    ...
    Student(stNum: "002", stName: "김길동"),
    Student(stNum: "003", stName: "이길동"),
    Student(stNum: "004", stName: "박길동"),
